...
Examples:
  ...
  mite projects update --archived true 123456

  Unarchive a single project
    mite projects update --archived false 123456

  Unarchive all archived projects
    mite projects --columns id --format=text | xargs -0 mite projects update --archived false
`);
  })
  .action((projectId) => {
