...
## [1.11.1](https://github.com/Ephigenia/mite-cli/compare/v1.11.0...v1.11.1) (2026-09-14)
...
* 0 revenue returns as number instead of blank ([cacb4dc](https://github.com/Ephigenia/mite-cli/commit/cacb4dcd0d09947c9439db91955ae64f9a3c2eb4))
* **deps:** update dependency open to v8.0.5 ([#143](https://github.com/Ephigenia/mite-cli/issues/143)) ([a74b6e3](https://github.com/Ephigenia/mite-cli/commit/a74b6e3f0b1d7977bab20800efac7d579909861e))
* **deps:** update dependency open to v8.0.6 ([#147](https://github.com/Ephigenia/mite-cli/issues/147)) ([3759f6d](https://github.com/Ephigenia/mite-cli/commit/3759f6d57c7c91f7419f1f06243ccdda9427a007))
* format artifact ([ff03472](https://github.com/Ephigenia/mite-cli/commit/ff03472b1f47b32731c8457041e324c71e31a172))
* number with units omit space ([040af74](https://github.com/Ephigenia/mite-cli/commit/040af747d4b0ce7bc860463fd00a796b27d999a7))
* undefined config outputFormat handling ([6b7e4ac](https://github.com/Ephigenia/mite-cli/commit/6b7e4acc45550fbd9e0075df4678942f0b627411))
...
* **deps:** update dependency commander to v7 ([#117](https://github.com/Ephigenia/mite-cli/issues/117)) ([491cb6b](https://github.com/Ephigenia/mite-cli/commit/491cb6b8f48930596c54cf0e78f19cdf45fb29ed))
* **deps:** update dependency inquirer to v8 ([#132](https://github.com/Ephigenia/mite-cli/issues/132)) ([074569e](https://github.com/Ephigenia/mite-cli/commit/074569eeb06b970082f2ca55e6c016cd4182f69b))
* **deps:** update dependency nconf to ^0.11.0 ([#103](https://github.com/Ephigenia/mite-cli/issues/103)) ([a1117fe](https://github.com/Ephigenia/mite-cli/commit/a1117fe73782d0ef50e340d5d84776ed0aedccca))
* **deps:** update dependency open to v7.3.1 ([#116](https://github.com/Ephigenia/mite-cli/issues/116)) ([7b53c7a](https://github.com/Ephigenia/mite-cli/commit/7b53c7a94a1f51f5b511dfc5db80cb4a87822fd7))
* **deps:** update dependency open to v7.4.0 ([#122](https://github.com/Ephigenia/mite-cli/issues/122)) ([bbccc2a](https://github.com/Ephigenia/mite-cli/commit/bbccc2af289e0bb8a82756be743ec82f5455ed7c))
* **deps:** update dependency open to v7.4.2 ([#129](https://github.com/Ephigenia/mite-cli/issues/129)) ([6ecd44c](https://github.com/Ephigenia/mite-cli/commit/6ecd44c4d0c648bb693cb9e82cfde687aa304c7d))


### Features

* adds cache to autocompletion mite-api requests [#83](https://github.com/Ephigenia/mite-cli/issues/83) ([#104](https://github.com/Ephigenia/mite-cli/issues/104)) ([04d866c](https://github.com/Ephigenia/mite-cli/commit/04d866cc8a5950f9c5b4f728be24b281da538c51))



# [1.6.0](https://github.com/Ephigenia/mite-cli/compare/v1.5.0...v1.6.0) (2020-11-23)


### Bug Fixes

* autocomplete install/uninstall wait for user input [#101](https://github.com/Ephigenia/mite-cli/issues/101) ([#102](https://github.com/Ephigenia/mite-cli/issues/102)) ([625deaf](https://github.com/Ephigenia/mite-cli/commit/625deafb2e5e5897065ef60514b018d56b0d3a14))
* **config:** json parsing error handling using erro handler ([#62](https://github.com/Ephigenia/mite-cli/issues/62)) ([8e56fac](https://github.com/Ephigenia/mite-cli/commit/8e56fac94633cd711ec82654a740bb29f83247d3))
* **deps:** update dependency open to v7.2.0 ([#65](https://github.com/Ephigenia/mite-cli/issues/65)) ([edb9329](https://github.com/Ephigenia/mite-cli/commit/edb9329259e4063b2358ab7cd7963b027a4d1b96))
* **deps:** update dependency open to v7.2.1 ([#67](https://github.com/Ephigenia/mite-cli/issues/67)) ([9f809c5](https://github.com/Ephigenia/mite-cli/commit/9f809c5ae97a36153e4e46cd26be8a4b46fa4a99))
* **deps:** update dependency open to v7.3.0 ([#84](https://github.com/Ephigenia/mite-cli/issues/84)) ([a0cfd65](https://github.com/Ephigenia/mite-cli/commit/a0cfd65fc571f4bec9ebd61d3a35205a684be073))
* **deps:** update dependency table to v6 ([#69](https://github.com/Ephigenia/mite-cli/issues/69)) ([3b887ef](https://github.com/Ephigenia/mite-cli/commit/3b887efa30e1f6ad0d34a79b3ec9450d638a6dff))
* format option lowercased ([38b1826](https://github.com/Ephigenia/mite-cli/commit/38b18266bd10515958c6408e1c9e55c910116017))


### Features

* adds alias mite resume which runs mite start --last ([#78](https://github.com/Ephigenia/mite-cli/issues/78)) ([69489aa](https://github.com/Ephigenia/mite-cli/commit/69489aad3d94b11d197c099aa536dea78c9e61e0))
* amend last & start --last ([#82](https://github.com/Ephigenia/mite-cli/issues/82)) ([d193b35](https://github.com/Ephigenia/mite-cli/commit/d193b35d50891eeeffc975e940b4bd62fbecf81f)), closes [#77](https://github.com/Ephigenia/mite-cli/issues/77) [#77](https://github.com/Ephigenia/mite-cli/issues/77)
* **amend:** adds user-id option to change assigend user ([8444405](https://github.com/Ephigenia/mite-cli/commit/844440522f448dcc1e7bce3623544cc16d0d661d))
* list understands 1y or 2year ([#26](https://github.com/Ephigenia/mite-cli/issues/26)) ([14d0140](https://github.com/Ephigenia/mite-cli/commit/14d0140f94628eea7cf080cd894c7dccba9abef8))
